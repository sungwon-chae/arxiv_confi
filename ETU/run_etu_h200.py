...
def get_h200_optimized_args():
    ...
    # LoRA 최적화 (removed duplicate - see below)
    ...
    # V_S 디버깅 옵션
    parser.add_argument("--vs_debug", action="store_true",
                       help="V_S/PMI/빈도/π_base(S) 등을 상세 덤프")
    parser.add_argument("--vs_debug_topk", type=int, default=200,
                       help="텍스트 프린트/표시할 상위 토큰 수")
